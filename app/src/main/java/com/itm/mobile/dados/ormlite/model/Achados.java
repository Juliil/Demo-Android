...
@DatabaseTable(tableName="TB_ACHADOS")
public class Achados implements Serializable {
    ...
    public final static String SITUACAO = "situacao"; // 0 - Pendente, 1 - Resgatado
    ...
    public Achados(Date dt_reg, Date dt_fato, String local, Double local_lat, Double local_long, int situacao) {
        this.dt_reg = dt_reg;
    ...
    public List<?> populateCateg(){
        List<Achados> list  = new ArrayList<>();
        //(Date dt_reg, Date dt_fato, String local, Double local_lat, Double local_long, int situacao)
        list.add(new Achados(new Date(), new Date(), "Proximo a Av das Torres", 0.0,0.0,0));
        list.add(new Achados(new Date(), new Date(), "Proximo a Av do Turismo", 0.0,0.0,0));
        list.add(new Achados(new Date(), new Date(), "Proximo ao Centro da Cidade", 0.0,0.0,0));
        list.add(new Achados(new Date(), new Date(), "Proximo a Igreja Dos Remédios", 0.0,0.0,0));
        list.add(new Achados(new Date(), new Date(), "Proximo a ao Porto", 0.0,0.0,0));
        return list;
    }
}
